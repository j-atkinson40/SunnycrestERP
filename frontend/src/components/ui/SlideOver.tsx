...
export function SlideOver({
  ...
  return (
    <div className="fixed inset-0 pointer-events-none" style={{ zIndex }}>
      ...
      <div
        className={`absolute right-0 top-0 h-full w-full ${WIDTHS[width]} bg-surface-raised shadow-level-3 [background-image:var(--panel-gradient-raised)] pointer-events-auto flex flex-col transition-transform duration-arrive ease-settle font-sans text-content-base`}
