 ...
 *   - border border-border-subtle (§6: "dropdowns get subtle border
 *     definition at small sizes where shadow alone isn't enough")
 *   - rounded-md (8px) — standard dropdown menu radius
 *   - shadow-level-2 — raised composition
 *   - p-2 — §6 surface composition pattern
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.GroupLabel
      ...
      className={cn(
        "px-2 py-1 text-micro font-medium uppercase tracking-wider text-content-subtle",
        className
      )}
      {...props}
    />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "top-0 z-10 flex w-full cursor-default items-center justify-center bg-surface-raised py-1 text-content-muted [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bottom-0 z-10 flex w-full cursor-default items-center justify-center bg-surface-raised py-1 text-content-muted [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
