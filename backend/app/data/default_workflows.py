...
TIER_1_WORKFLOWS.extend([
    {
        ...
        "params": [
            ...
            {"step_key": "notify_admin", "param_key": "notify_user_ids",
             "label": "Also notify specific people", "param_type": "user_multi_select",
             "default_value": [], "is_configurable": True,
             "description": "For the fringe cases roles don't cover."},
        ],
    },
    {
...
_TIER_1_PARAM_UPDATES = {
    ...
    "wf_sys_legacy_print_final": [
        ...
        {"step_key": "send_to_production", "param_key": "notify_user_ids",
         "label": "Also notify specific people", "param_type": "user_multi_select",
         "default_value": [], "is_configurable": True,
         "description": "For the fringe cases roles don't cover."},
    ...
    "wf_sys_compliance_sync": [
        ...
        {"step_key": "upsert_vault_items", "param_key": "notify_roles",
         "label": "Notify these roles", "param_type": "role_multi_select",
         "default_value": ["admin"], "is_configurable": True},
        {"step_key": "upsert_vault_items", "param_key": "notify_user_ids",
         "label": "Also notify specific people", "param_type": "user_multi_select",
         "default_value": [], "is_configurable": True,
         "description": "For the fringe cases roles don't cover."},
    ],
