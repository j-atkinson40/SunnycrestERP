...
EXTENSION_CATALOG = [
    ...
    # ── Funeral Home vertical — active extensions ──
    {
        "extension_key": "ai_obituary_builder",
        "module_key": "funeral_home",
        "display_name": "AI Obituary Builder",
        "tagline": "Generate personalized obituaries from biographical details using AI",
        "description": "Create compassionate, personalized obituaries from basic biographical information using AI. Directors enter family details, career highlights, and special memories, and the system drafts a polished obituary ready for review. Supports multiple tone options and family approval workflow.",
        "category": "workflow",
        "applicable_verticals": ["funeral_home"],
        "default_enabled_for": [],
        "access_model": "included",
        ...
        "version": "1.0.0",
        "feature_bullets": [
            "AI-generated obituary drafts from biographical data",
            "Multiple tone options (warm, formal, celebratory)",
            "Family review and approval workflow",
            "Multi-publication distribution tracking",
            "Automatic integration with memorial pages",
        ],
        "setup_required": False,
        "sort_order": 105,
    ...
    {
        "extension_key": "ftc_compliance",
        "module_key": "funeral_home",
        "display_name": "FTC Funeral Rule Compliance",
        "tagline": "Automatic FTC Funeral Rule compliance for pricing, disclosures, and documentation",
        "description": "Ensures your funeral home stays compliant with the FTC Funeral Rule. Automatically validates your General Price List, generates required disclosures, and maintains documentation that satisfies FTC audit requirements. Cannot be disabled for funeral home tenants.",
        "category": "compliance",
        "applicable_verticals": ["funeral_home"],
        "default_enabled_for": ["funeral_home"],
        "access_model": "included",
        "status": "active",
        "version": "1.0.0",
        "feature_bullets": [
            "GPL validation against FTC Funeral Rule requirements",
            "Required disclosure generation",
            "Itemized statement of goods and services",
            "FTC audit-ready documentation package",
    ...
    # ── Funeral Home vertical — coming soon ──
    {
        ...
        "module_key": "pre_need_contracts",
        "display_name": "Pre-Need Contract Management",
        "tagline": "Manage pre-need arrangements, funded contracts, and at-need conversion",
        "description": "Full pre-need contract management including funded and unfunded arrangements, insurance assignment tracking, trust fund documentation, and automatic conversion to at-need cases when the time comes.",
        "category": "workflow",
        "applicable_verticals": ["funeral_home"],
        "default_enabled_for": [],
        "access_model": "included",
        ...
        "version": "0.1.0",
        "feature_bullets": [
            "Funded and unfunded contract tracking",
            "Insurance assignment documentation",
            "Trust fund balance tracking",
            "Automatic at-need case creation on conversion",
            "Pre-need sales pipeline and reporting",
        ],
        "setup_required": True,
        "sort_order": 300,
        "cannot_disable": False,
    ...
    {
        "extension_key": "cremation_workflow_full",
        "module_key": "cremation_workflow_full",
        "display_name": "Full Cremation Workflow",
        "tagline": "Complete cremation operations from authorization through remains release",
        "description": "Extends basic cremation tracking with full operational workflow including cremation authorization documentation, chain of custody tracking, cremation scheduling, processing records, and remains release documentation.",
        "category": "workflow",
        "applicable_verticals": ["funeral_home"],
        "default_enabled_for": [],
        "access_model": "included",
        ...
        "version": "0.1.0",
        "feature_bullets": [
            "Cremation authorization with legal signature capture",
            "Chain of custody at every transfer point",
            "Cremation scheduling and processing records",
            "Remains processing and packaging documentation",
            "Release authorization and delivery tracking",
        ],
        "setup_required": False,
        "sort_order": 310,
        "cannot_disable": False,
    ...
    {
        "extension_key": "florist_one_integration",
        "module_key": "funeral_home",
    ...
    {
        "extension_key": "pet_cremation_workflow",
        "module_key": "funeral_home",
    ...
    {
        "extension_key": "trade_crematory_portal",
        "module_key": "funeral_home",
    ...
    {
        "extension_key": "casket_ordering_integration",
        "module_key": "funeral_home",
    ...
    {
        "extension_key": "funeral_website_builder",
        "module_key": "funeral_home",
