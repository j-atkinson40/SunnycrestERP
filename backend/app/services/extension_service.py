...
EXTENSION_CATALOG = [
    ...
    # ── BASIC OPERATIONS (section: basic_operations) ──
    {
        ...
        "description": "A focused purchasing workflow designed for small manufacturing operations. Manage your vendors, create and send purchase orders, receive against POs, and track what you owe. Exports to your accounting system via Sage-compatible CSV. No complex approval workflows — just the purchasing flow a 15-person operation actually needs.",
        ...
        "feature_bullets": [
            ...
            "Accounting export for AP transactions",
        ],
        "setup_required": True,
        "sort_order": 1,
    },
    ...
    },
    {
        ...
        "description": "A lean POS for manufacturers who sell direct at the counter or yard. Process walk-in sales, accept cash or card, print receipts. Inventory updates automatically. Exports to your accounting system via Sage-compatible CSV. Designed for vault yards and precast operations, not retail stores.",
        "section": "basic_operations",
        "category": "operations",
        "applicable_verticals": ["manufacturing"],
        "default_enabled_for": [],
        ...
        "feature_bullets": [
            ...
            "Accounting export for sales transactions",
        ],
        "setup_required": True,
        "sort_order": 3,
    },
