...
class StatementRun(Base):
    ...
    # Generation service columns
    run_date: Mapped[date] = mapped_column(Date, nullable=False, default=date.today)
    period_start: Mapped[date | None] = mapped_column(Date, nullable=True)
    period_end: Mapped[date | None] = mapped_column(Date, nullable=True)
    # Legacy month/year columns (used by initiate_run flow)
    statement_period_month: Mapped[int | None] = mapped_column(Integer, nullable=True)
    statement_period_year: Mapped[int | None] = mapped_column(Integer, nullable=True)
